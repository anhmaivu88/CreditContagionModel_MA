...
class BaseScheduler:
    ...
    def add(self, agent):
        ...
        """
        self.activatingAgents.append(agent)
    ...
    def remove(self, agent):
        ...
        """
        while agent in self.activatingAgents:
            self.activatingAgents.remove(agent)
        self.deactiveAgents.append(agent)
...
class StagedActivation(BaseScheduler):
    ...
    def step(self):
        ...
        for stage in self.stage_list:
            for agent in self.activatingAgents[:]:
                getattr(agent, stage)()  # Run stage
            if self.shuffle_between_stages:
                random.shuffle(self.activatingAgents)
